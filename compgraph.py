...
Computational graph module, vendored from the EPypes project

Removed:

CompGraph.to_cg_with_nodes
create_nodes_from_comp_graph
NodeBasedCompGraph

'''

from graph import BipartiteDigraph, DepthFirstOrder
